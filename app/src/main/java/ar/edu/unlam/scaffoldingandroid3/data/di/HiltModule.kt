...
import ar.edu.unlam.scaffoldingandroid3.domain.services.CreateMonumentoService
...
object HiltModule {
    ...
    @Singleton
    @Provides
    fun provideCreateMonumentoUseCase(repo: LocalMonumentRepository): CreateMonumentoUseCase = CreateMonumentoService(repo)
}
